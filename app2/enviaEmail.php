...
$msg = "<html><head><meta charset='utf-8'></head><body>
    ...
    <strong>Método de pagamento: </strong>".$metodoPagto."<br>";
...
$msg = "<html><head><meta charset='utf-8'></head><body>
    ...
    Oi ".$xml['sender']['name'].",<br>
    Ficamos muito felizes em receber o seu pedido <i><u>".$xml['reference']."</i></u> :)<br>
    Aqui estão algumas informações importantes:<br>
    ...
    ou, ainda, pela verificação do seu depósito bancário.<br>
    ...
    if($metodoPagto == "Boleto Bancário"){
        $msg .= "<a href='".$xml['paymentLink']."' target='_blank'>Link do boleto</a><br>";
    }
    
    $msg .= "Abra um sorriso Na Casa da Joana :)<br><br>
